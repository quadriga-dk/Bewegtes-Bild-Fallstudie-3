...
```{figure} ../assets/02_forschungsdaten_fdm/abb_k02_sfb_projekt.png
---
name: sfb-projekt
---
Kontextualisierte Visualisierung der Annotationsdaten
```
...
```{figure} ../assets/02_forschungsdaten_fdm/abb_k02_moviebarcodes_exemplare.png
---
